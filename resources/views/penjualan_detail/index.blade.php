    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-bodyx">
                            ...
                            <div class="col-lg-5">
                                <div class="input-group mb-4">
                                    ...
                                    <span class="input-group-btn">
                                        <button onclick="tampilProduk()" class="btn btn-secondary btn-flat" type="button"><i class="fa fa-arrow-right"></i></button>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="tampil-bayar bg-gradient-dark"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group mb-3">
                                        ...
                                        <span class="input-group-btn">
                                            <button onclick="tampilMember()" class="btn btn-secondary btn-flat" type="button"><i class="fa fa-arrow-right"></i></button>
                                        </span>
                                </div>
                            </div>
                            <div class="form-group row">
...
<script>
    ...
    $(function () {
        ...
        $(document).on('input', '.quantity', function () {
            ...
            if (jumlah > 10000) {
                $(this).val(10000);
                alert('Jumlah tidak boleh kurang dari 10000');
            }

                ...
                <form action="{{ route('user.update_profil') }}" method="post" class="form-profil" data-toggle="validator"  enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-lg-2 offset-1 control-label">Nama</label>
                            <div class="col-lg-4">
                                <input type="text" name="name" class="form-control" id="name" required autofocus value="{{ $profil->name }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="foto" class="col-lg-2 offset-1 control-label">Profil</label>
                            <div class="col-lg-4">
                        ...
                        <div class="form-group row">
                            <label for="old_password" class="col-lg-2 offset-1 control-label">Password Lama</label>
                            <div class="col-lg-4">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-lg-2 offset-1 control-label">Password</label>
                            <div class="col-lg-4">
                        ...
                        <div class="form-group row">
                            <label for="password_confirmation" class="col-lg-2 offset-1 control-label">Konfirmasi Password</label>
                            <div class="col-lg-4">

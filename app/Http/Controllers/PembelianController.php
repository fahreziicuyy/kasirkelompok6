    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($pembelian) {
                return '
                <div class="btn-group">
                    <button onclick="showDetail(`'. route('pembelian.show', $pembelian->id_pembelian) .'`)" class="btn btn-xs btn-info btn-flat"  style="margin-right: 5px;"><i class="fa fa-eye"></i></button>

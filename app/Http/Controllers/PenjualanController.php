    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($penjualan) {
                return '
                <div class="btn-group">
                    <button onclick="showDetail(`'. route('penjualan.show', $penjualan->id_penjualan) .'`)" class="btn btn-xs btn-info btn-flat"  style="margin-right: 5px;"><i class="fa fa-eye"></i></button>

    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($pengeluaran) {
                return '
                <div class="btn-group">
                    <button type="button" onclick="editForm(`'. route('pengeluaran.update', $pengeluaran->id_pengeluaran) .'`)" class="btn btn-xs btn-info btn-flat" style="margin-right: 5px;"><i class="fa fa-cog"></i></button>
